...
function love.graphics.hexagon(mode, x,y,l) --左上角第一个点
    local i=(l/2)*3^0.5
    love.graphics.polygon(mode, x-l/2,y-i,x+l/2,y-i,x+l,y,x+l/2,y+i,x-l/2,y+i,x-l,y)
end
...
function math.pointTest_xy(x,y,pX,pY) --px={} py={}
    local oddNodes=false
    local pCount=#pX
    local j=pCount
    for i=1,pCount do
